...
exports.generateSecureEnvVars = generateSecureEnvVars;
exports.validateOrThrow = validateOrThrow;
exports.getValidatedRpcUrl = getValidatedRpcUrl;
...
function validateEnvironment() {
    ...
    if (!jwtSecret) {
        if (isDeployment) {
            ...
            jwtSecret = crypto_1.default.randomBytes(64).toString('base64');
    ...
    if (!encryptionKey) {
        if (isDeployment) {
            ...
            encryptionKey = crypto_1.default.randomBytes(32).toString('hex');
 ...
 */
function generateSecureEnvVars() {
    const jwtSecret = crypto_1.default.randomBytes(64).toString('base64');
    const encryptionKey = crypto_1.default.randomBytes(32).toString('hex');
    return {
