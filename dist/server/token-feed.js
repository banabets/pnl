...
class TokenFeedService extends events_1.EventEmitter {
    ...
    async fetchBasicMetadata(mint) {
        try {
            ...
            logger_1.log.info('🎯 Fetching basic metadata from Pump.fun', { mint: mint.slice(0, 8) });
            ...
            if (response.ok) {
                ...
                logger_1.log.info('✅ Basic metadata fetched successfully', {
                    mint: mint.slice(0, 8),
                    name: existing.name,
                    symbol: existing.symbol
                });
            ...
            logger_1.log.warn('Failed to fetch basic metadata', {
                mint: mint.slice(0, 8),
                error: error.message
            });
        }
